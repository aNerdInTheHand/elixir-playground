defmodule MatchEngine.MatchReport do
  ...
  def generate_report(
    ...
    surprise_factor =
      determine_surprise_factor(ovr_diff, winner) |> IO.inspect(label: "Surprise Factor")
  ...
  def generate_match_report(home_team, away_team, home_goals, away_goals, winner, surprise_factor) do
    ...
    report_body =
      cond do
        winner == :draw and surprise_factor == 0 ->
          MatchReportSummaries.draw_responses(
            surprise_factor,
            home_team,
            away_team,
            home_goals,
        ...
        winner == :draw and surprise_factor == 1 ->
          MatchReportSummaries.draw_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :draw and surprise_factor == 2 ->
          MatchReportSummaries.draw_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :draw and surprise_factor == 3 ->
          MatchReportSummaries.draw_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :draw and surprise_factor == 4 ->
          MatchReportSummaries.draw_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :draw and surprise_factor == 5 ->
          MatchReportSummaries.draw_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :home and surprise_factor == 0 ->
          MatchReportSummaries.home_win_responses(
            surprise_factor,
            home_team,
            away_team,
            home_goals,
        ...
        winner == :home and surprise_factor == 1 ->
          MatchReportSummaries.home_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :home and surprise_factor == 2 ->
          MatchReportSummaries.home_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :home and surprise_factor == 3 ->
          MatchReportSummaries.home_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :home and surprise_factor == 4 ->
          MatchReportSummaries.home_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :home and surprise_factor == 5 ->
          MatchReportSummaries.home_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :away and surprise_factor == 0 ->
          MatchReportSummaries.away_win_responses(
            surprise_factor,
            home_team,
            away_team,
            home_goals,
        ...
        winner == :away and surprise_factor == 1 ->
          MatchReportSummaries.away_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :away and surprise_factor == 2 ->
          MatchReportSummaries.away_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :away and surprise_factor == 3 ->
          MatchReportSummaries.away_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :away and surprise_factor == 4 ->
          MatchReportSummaries.away_win_responses(
            surprise_factor,
            home_team,
            away_team,
        ...
        winner == :away and surprise_factor == 5 ->
          MatchReportSummaries.away_win_responses(
            surprise_factor,
            home_team,
            away_team,
